    ...
    return (
        <>
            ...
            <div className='container pt-[2rem] flex flex-col gap-5'>
                <div className='text-center h-[20rem] rounded-lg bg-cover bg-hire text-white w-full flex justify-center flex-col gap-4'>
                    <h1 className='font-extrabold text-[2.2rem]'>Search For a Right Candidate</h1>
